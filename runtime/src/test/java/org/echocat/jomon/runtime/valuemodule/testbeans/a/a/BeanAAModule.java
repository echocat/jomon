...
public enum BeanAAModule implements ValueModule {
    a,
    b,

    all(a, b);

    private final Set<BeanAAModule> _includes;

    private BeanAAModule(@Nullable BeanAAModule... includes) {
    ...
    @Nullable
    @Override
    public Collection<BeanAAModule> getIncludes() {
        return _includes;
    }
