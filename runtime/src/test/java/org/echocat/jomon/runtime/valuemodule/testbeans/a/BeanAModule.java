...
public enum BeanAModule implements ValueModule {
    a,
    b,

    all(a, b);

    private final Set<BeanAModule> _includes;

    private BeanAModule(@Nullable BeanAModule... includes) {
    ...
    @Nullable
    @Override
    public Collection<BeanAModule> getIncludes() {
        return _includes;
    }
